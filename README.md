...
I use R to conduct statistical analyses and data manipulation primarily, including running SQL queries in R. However I am also familiar with with Python and SQL language. 
